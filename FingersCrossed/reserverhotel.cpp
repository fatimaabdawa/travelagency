...
QSqlQueryModel * reserverhotel:: chercher(QString valeur)
{
    QSqlQueryModel * model = new QSqlQueryModel();
    QSqlQuery query;

    query.prepare(QString("select * from reserverhotel where idhotel like :valeur"));
valeur='%'+valeur+'%';
...
QSqlQueryModel * reserverhotel::trie_idhotel()
{ QSqlQueryModel * model = new QSqlQueryModel();
    QSqlQuery query;
    query.prepare(QString("SELECT * FROM reserverhotel ORDER BY idhotel;"));
    query.exec();
    model->setQuery(query);
    return model;
}
QSqlQueryModel * reserverhotel::trie_nomH()
{
    QSqlQueryModel * model = new QSqlQueryModel();
    QSqlQuery query;
    query.prepare(QString("SELECT * FROM reserverhotel ORDER BY nomhotel;"));
    query.exec();
    model->setQuery(query);
    return model;
}
